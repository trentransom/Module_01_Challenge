...
print(f'''There are {number_of_loans} loans with a total value of ${total_loan_amount}.
The average loan amount is ${average_loan_amount}''')
...
print(f'The number of remaining months on this loan is {remaining_months}')
